...
@section('title','Regiones edit')

@section('content')
<h1>Editar Region</h1><br>
...
<div class="py-8 bg-gray-100">
    <div class="w-full max-w-6xl px-4 mx-auto sm:px-6 md:px-8">
        ...
        <div class="grid md:grid-cols-[2fr,3fr] gap-6 md:gap-12 mt-6">
            ...
            action="{{route('regiones.update', $region)}}" method="post">
                ...
                <div class="grid grid-cols-2 gap-1">
                    <div class="col-span-2 space-y-1 md:col-span-1">
                        <label class="inline-block text-sm font-medium text-gray-900"
                            ...
                            id=""
                            type="text" name="nombre_r" value="{{old('nombre_r', $region->nombre_r)}}">
                    ...
                    <div class="col-span-2 space-y-2 md:col-span-1">
                        ...
                        <textarea
                            ...
                            id="des_r" name="des_r">{{old('des_r', $region->des_r)}}</textarea>
